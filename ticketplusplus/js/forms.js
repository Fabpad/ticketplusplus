...
function createnewticket(form, betreff, beschreibung, user, agent, status, priority, category, specification) {
    ...
    if(document.getElementById('choose_user_id').disabled == true){
        document.getElementById('choose_user_id').disabled = false;
    }
...
function night_mode(){
    if(Number(sessionStorage.nightMode)=='1'){
        ...
        document.documentElement.style.setProperty('--readonly',"#1E1E1E");
        if (document.getElementById('nightmodeinput')){
            document.getElementById('nightmodeinput').value = 'ON';
        }
    }
        ...
        document.documentElement.style.setProperty('--readonly',"#e9ecef");
        if (document.getElementById('nightmodeinput')){
            document.getElementById('nightmodeinput').value = 'OFF';
        }
    }
