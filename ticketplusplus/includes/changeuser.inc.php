...
if (isset($_POST['userid'], $_POST['username'], $_POST['uservorname'],$_POST['usernachname'], $_POST['dept'], $_POST['role'] $_POST['telnr'], $_POST['email'])) {
    $userid = $_POST['userid'];
    ...
    if (empty($message)) {
        ...
        $sql = "UPDATE ticketplusplus.users 
                SET username = $username, email = $email, vorname = $vorname, nachname = $nachname, telefonnummer = $telnummer, dept_id = $deptID, role_id = $roleID
                WHERE id = $userid";
